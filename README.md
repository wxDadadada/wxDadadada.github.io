...
<html>
  <head>
    ...
    <title>王小大易支付网址导航</title>
    <meta name="keywords" content="王小大易支付网址导航">
    <meta name="description" content="最新地址发布页,回家不迷路">
    ...
    <style type="text/css">
      *{padding:0;margin:0}
      ...
      .enter-ping{width:80px;height:41px;float:right;background-color:#00c250}
  ...
  <body>
    <div id="main">
      <div class="brand" id="logo">
        <span>王小大易支付</span><span class="flag">网址导航</span>
      </div>
      <div class="field">
        <div class="enter-maomi">
          ...
          <div class="enter-ping">
            <span class="text-white">0 ms</span>
          </div>
          <div class="enter-link">
            <a href="https://epay.wxda.net" target="_blank"><span class="c_blue">epay.wxda.net</span> </a>
          </div>
        </div>
        <div class="enter-maomi">
          <div class="enter-icon">
          ...
          <div class="enter-link">
            <a href="https://epay.wxda.tech" target="_blank"><span class="c_blue">epay.wxda.tech</span> </a>
          </div>
        </div>
        <div class="enter-maomi">
          <div class="enter-icon">
          ...
          <div class="enter-link">
            <a href="https://epay.wxda.studio" target="_blank"><span class="c_blue">epay.wxda.studio</span> </a>
          </div>
        </div>
        <div class="enter-maomi">
          <div class="enter-icon">
          ...
          <div class="enter-link">
            <a href="https://epay.wxda.me" target="_blank"><span class="c_blue">epay.wxda.me</span> </a>
          </div>
        </div>
        <div class="enter-maomi">
          <div class="enter-icon">
          ...
          <div class="enter-link">
            <a href="https://epay.wxda.cc" target="_blank"><span class="c_blue">epay.wxda.cc</span> </a>
          </div>
        </div>
        <p class="c_blue c_link">请多多访问支持</p>
      </div>
      <div class="field ">
